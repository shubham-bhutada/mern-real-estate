...
const Search = () => {
  return (
    <div className='flex flex-col md:flex-row'>
        <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
            <form className='flex flex-col gap-8'>
                <div className="flex gap-2 items-center">
                    ...
                    <input type="text" placeholder='Search...' id='searchTerm' className='p-3 border rounded-lg w-full outline-none' />
                </div>
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <select name="" id="" className='border rounded-lg p-3 outline-none'>
        ...
        <div className="p-7">
            <h1 className='text-3xl font-semibold border-b text-slate-700'>Listing Results</h1>
        </div>
    </div>
  )
}
