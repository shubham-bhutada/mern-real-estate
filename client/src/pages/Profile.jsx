...
const Profile = () => {
  ...
  return (
    <div className="max-w-lg p-3 mx-auto">
      ...
      {showListingsError && (
        <p className="text-red-700 text-sm mt-5">Error Showing listings</p>
      )}
      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4">
          <h1 className="text-center text-slate-700 text-2xl font-semibold underline">
            Your Listings
          </h1>
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className="flex items-center p-3 border rounded-lg justify-between gap-4"
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <Link to={`/update-listing/${listing._id}`}>
                  <button className="text-blue-700 uppercase font-semibold">
                    Edit
                  </button>
                </Link>
              </div>
